...
<fieldset>
    ...
    <div class="row one_input">
        ...
        <h6 for="transmission" style="width: 100%;"><?php _e('Transmission', 'cars_attributes'); ?></h6>
        <input style="width:20px;" type="radio" name="transmission" value="MANUAL" id="manual" <?php if($transmission == 'MANUAL') { echo 'checked="yes"'; } ?>/> <label for="manual" style="padding-right: 25px;"><?php _e('Manual', 'cars_attributes'); ?></label><br />
